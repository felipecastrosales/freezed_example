...
class _$UnionTearOff {
  ...
  UnionData call(int value) {
    return UnionData(
      value,
    );
  }

  UnionLoading loading() {
    return UnionLoading();
  }

  UnionError error([String? message]) {
    return UnionError(
      message,
    );
  }
...
abstract class UnionData implements Union {
  factory UnionData(int value) = _$UnionData;
...
abstract class UnionError implements Union {
  factory UnionError([String? message]) = _$UnionError;
